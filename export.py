...
class Export:
    ...
    def convert2rknn(self, model_type: str,  _target_platform='rk3588'):
        ...
        _checking_dir([self.working_dir + "/models", self.working_dir + "/export"])
        ...
        for i, model in enumerate(models):
            ...
            ret = rknn.export_rknn(f"{export_path}/{_get_filename_without_extension(model)}.rknn")
            if ret != 0:
